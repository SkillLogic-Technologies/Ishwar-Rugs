...
import { LayoutDashboard, Package, Grid2X2, Layers, ShoppingCart, Users, MessageSquare, X } from "lucide-react";
...
export default function AdminSidebar({isOpen,setIsOpen}) {
  ...
  },
  {
    ...
    icon: Layers,
    match: ["/admin/collections","/admin/add-collection", "/admin/edit-collection", "/admin/delete-collection"],
  },
    {
      name: "Orders",
      path: "/admin/orders",
    ...
    },
    {
      ...
      icon: Users,
        match: ["/admin/customers","/delete-customers"],
    },
    {
      name: "Inquiries",
